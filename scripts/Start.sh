...
#python main.py --beta 2 --lam 0.5 --lr 1e-4 --alpha 0.1 --k 5 --anormly_ratio 1 --num_epochs 3   --batch_size 128  --mode train --dataset MSL  --data_path dataset/MSL --input_c 55    --output_c 55
python main.py --beta 2 --lam 0.5 --lr 0.1 --alpha 0.1 --k 9 --anormly_ratio 1  --num_epochs 10      --batch_size 128     --mode test    --dataset MSL   --data_path dataset/MSL  --input_c 55    --output_c 55  --pretrained_model 20

#python main.py --beta 2 --lam 0.5 --lr 1e-4 --alpha 0.1 --k 5 --anormly_ratio 1 --num_epochs 3   --batch_size 128  --mode train --dataset SMAP  --data_path dataset/SMAP --input_c 25    --output_c 25
#python main.py --beta 2 --lam 0.5 --lr 1e-4 --alpha 0.1 --k 5 --anormly_ratio 1  --num_epochs 10        --batch_size 128     --mode test    --dataset SMAP   --data_path dataset/SMAP  --input_c 25    --output_c 25  --pretrained_model 20
#
#
#python main.py --beta 2 --lam 0.5 --lr 1e-4 --alpha 0.1 --k 5 --anormly_ratio 1 --num_epochs 3    --batch_size 128  --mode train --dataset PSM  --data_path dataset/PSM --input_c 25    --output_c 25
#python main.py --beta 2 --lam 0.5 --lr 1e-4 --alpha 0.1 --k 5 --anormly_ratio 1  --num_epochs 10       --batch_size 128     --mode test    --dataset PSM   --data_path dataset/PSM  --input_c 25    --output_c 25  --pretrained_model 20